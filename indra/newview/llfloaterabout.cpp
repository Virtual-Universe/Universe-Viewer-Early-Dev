...
BOOL LLFloaterAbout::postBuild()
{
	...
	} // else use the ones in xml file, so we don't lose them if contributors.txt does not exist
	...
	}// else use the ones in xml file, so we don't lose them if translators.txt does not exist
