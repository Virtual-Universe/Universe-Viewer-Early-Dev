...
/**  (licence for the additional OpenSim / Aurora-Sim script functions)
 * Copyright (C) 2012 WhiteStarM (at) gmail.com
 ...
 **/
        ...
        // ---------------------------------------------
        // FORMATTING is matched/identical to LL/SL V3 Viewer (lindenlab-viewer-development-5b37c3f36be3)
		// Updated December 12, 2012 fixes
		// Current to Dec.06.2012:  OpenSimulator Version [OpenSim-68daeee-r/21344] & [Aurora-a8480b2-2012-12-05 16:14:18 -0800]
...
// OSSL Functions Aurora-Sim Unique
        addFunction(10.f, 0.f, dummy_func, "osReturnObject", NULL, "k"); // Aurora-Sim only
        addFunction(10.f, 0.f, dummy_func, "osReturnObjects", NULL, "f"); // Aurora-Sim Only
        addFunction(10.f, 0.f, dummy_func, "osShutDown", NULL, NULL); // Aurora-Sim Only
        addFunction(10.f, 0.f, dummy_func, "osAddAgentToGroup", NULL, "kss"); // Aurora-Sim Only
        addFunction(10.f, 0.f, dummy_func, "osRezObject", NULL, "svvriiiii"); // Aurora-Sim Only
//
