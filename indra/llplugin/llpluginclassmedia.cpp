...
void LLPluginClassMedia::setNoFollowScheme(const std::string &scheme)
{
	LLPluginMessage message(LLPLUGIN_MESSAGE_CLASS_MEDIA, "set_no_follow_scheme");
	message.setValue("scheme", scheme);
	sendMessage(message);
}
